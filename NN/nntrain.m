...
assert(nargin == 4 || nargin == 7,'number ofinput arguments must be 4 or 7')
    ...
    if ishandle(fhandle)
        if opts.validation == 1
            ...
            if (loss.val.e_frac(end) < loss.min_validation_class_err)
              ...
              disp(['New Best Model Validation Error Rate: ' num2str(loss.min_validation_class_err)]);
